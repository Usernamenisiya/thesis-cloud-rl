...
print("-"*80)
print(f"{'s2cloudless Baseline':<30} {acc_base*100:>10.2f}% {prec_base*100:>10.2f}% {rec_base*100:>10.2f}% {f1_base*100:>10.2f}% {iou_base:>10.4f}")
...
print("-"*70)
print(f"{'s2cloudless Baseline':<30} {thin_rec_base*100:>18.2f}% {'-':>14}")
